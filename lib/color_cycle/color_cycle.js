    ...
    array : [
        {
            ...
            cull: 1,
            data: [  
                { i: 0, short: 'G', desc: 'Green',  web: '#00ff00' },
                { i: 1, short: 'B', desc: 'Blue',   web: '#0000ff' },
                { i: 2, short: 'Y', desc: 'Yellow', web: '#ffff00' },
                { i: 3, short: 'O', desc: 'Orange', web: '#ff8800' },
                { i: 4, short: 'R', desc: 'Red',    web: '#ff0000' }
            ]
        }
    ]
};
