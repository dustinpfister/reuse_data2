    ...
    array : [
        {
            ...
            data: [  
                ...
                { i: 1, desc: 'Blue',   web: '#0000dd' },
                { i: 2, desc: 'Yellow', web: '#efef00' },
                { i: 3, desc: 'Orange', web: '#dd5500' },
                { i: 4, desc: 'Red',    web: '#dd0000' }
            ]
        }
    ]
};
...
color_cycle.parse_conf = ( conf = color_cycle.default_conf ) => {
    ...
    n.array.map( (obj) => {
        ...
        obj.first_index = obj.first_index === undefined ? 0 : obj.first_index;
        obj.ascending = obj.ascending === undefined ? true: obj.ascending;
        obj.discounts = obj.discounts || [];
        obj.cull = obj.cull === undefined ? 1 : obj.cull;
        obj.data = obj.data || default_conf.array[0].data;
        return obj;
    });
    return n;
};
